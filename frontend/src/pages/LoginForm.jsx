      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-surface/40 border border-white/10 backdrop-blur-2xl rounded-[40px] p-8 md:p-12 shadow-2xl animate-in fade-in zoom-in-95 duration-500 relative overflow-hidden">
          ...
          <div className="text-center mb-10 relative z-10">
            ...
            <p className="text-white/40 font-medium">Welcome back! Please login.</p>
          </div>

          <form onSubmit={handleLogin} className="space-y-4 relative z-10">
            <div className="relative group">
              <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-primary-pink transition-colors" size={20} />
              <input 
                type="email" 
            ...
            <div className="relative group">
              <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-primary-pink transition-colors" size={20} />
              <input 
                type="password" 
            ...
            <div className="flex justify-end">
              <button type="button" className="text-xs text-white/30 hover:text-primary-pink font-bold transition-colors">Forgot Password?</button>
            </div>
          ...
          <div className="relative flex items-center justify-center my-8 z-10">
            ...
            <span className="relative px-4 bg-transparent text-[10px] text-white/20 uppercase tracking-widest font-bold">Or login with</span>
          </div>
          ...
          <p className="text-center text-sm text-white/40 mt-10 font-medium relative z-10">
            ...
            <Link to="/signup" className="text-primary-pink font-black hover:underline underline-offset-4">Sign Up</Link>
          </p>
        </div>
      </div>
    </div>
